...
- **Chưa có đường thực thi cho Lark:** `lark` hiện mới chỉ có thể tồn tại như một preference được lưu, chưa có execution path tương ứng.
...
- Nó đã thể hiện một **mô hình hành động có cân nhắc quyền tự chủ**, khi thao tác lịch được định hướng qua skills nhưng chỉ thực thi qua proposal flow và xác nhận thay vì mặc định tự động hóa toàn phần.
